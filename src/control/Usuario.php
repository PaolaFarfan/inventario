...
try {
    ...
    $mail->Username   = 'inventario_paola@programacion2024.com';                     //SMTP username
    $mail->Password   = '~]V-bCj$t0?(';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('inventario_paola@programacion2024.com', 'Cambio de Contraseña');
    ...
    $mail->CharSet = 'UTF-8';                                
    $mail->Subject = 'Cambio de comtraseña';
    $mail->Body    = '
